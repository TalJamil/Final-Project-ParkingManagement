...
/**
 * The Vehicle class represents an individual vehicle in the parking management system.
...
public class Vehicle {
    ...
    public void setEntryTime(LocalDateTime entryTime) {
        ...
        this.available = true; // Vehicle entered the parking lot
    }
    ...
    public void setExitTime(LocalDateTime exitTime) {
        ...
        this.available = false; // Vehicle exited the parking lot
    }
     ...
     *
     * Business Logic:
     * - true: Vehicle has entered and is still in the parking lot
     * - false: Vehicle has not entered yet OR has already exited
     */
    ...
    public String toString() {
        ...
        return String.format("Vehicle[License: %s, Owner: %s, Status: %s]",
