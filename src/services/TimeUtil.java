...
/**
 * The services.TimeUtil class provides static factory methods for time and date conversions.
...
public class TimeUtil {
     ...
     * Date legacyDate = services.TimeUtil.toDate(now);
     *
     ...
     * LocalDateTime modern = services.TimeUtil.fromDate(legacyDate);
     */
     ...
     * Usage Example:
     * LocalDateTime now = LocalDateTime.now();
     * String formatted = services.TimeUtil.formatForDisplay(now);
