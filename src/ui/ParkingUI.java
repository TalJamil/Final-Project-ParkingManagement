...
import core.Vehicle;
import observer.DataReplication;
...
/**
 * The ui.ParkingUI class represents the command-line user interface (CLI) for the parking management system.
...
public class ParkingUI {
     ...
     *
     * Features provided:
     * - core.Vehicle entry and exit management
     ...
     * - observer.ParkingLog: Provides real-time logging of parking activities
     * - observer.DataReplication: Creates automatic backups of parking data
     */
            ...
            switch (choice) {
                ...
                case "1":
                    ...
                    try {
                        ...
                        System.out.println("✅ core.Vehicle parked successfully!");
                ...
                /**
                 * Case 4: Show Full Parking services.Report
